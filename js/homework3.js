...
createButtons();
filterAll();
document.querySelector("#korea").addEventListener("click", filterKorea);
document.querySelector("#japan").addEventListener("click", filterJapan);
document.querySelector("#china").addEventListener("click", filterChina);
